                            ...
                            <div className="contact-section__left">
                                ...
                                <div className="contact-card manager-card">
                                    ...
                                    <div className="manager-card__content">
                                        ...
                                        <a href="mailto:contact@verxeon.com" className="manager-card__link">Talk directly to me</a>
                                    </div>
                                </div>
                                ...
                                <div className="contact-card work-card">
                                    <div className="work-card__text">
                                        ...
                                        <Link href="/services" className="work-card__link">View all services</Link>
                                    </div>
